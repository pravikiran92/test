...
<table border="1" id="customers">
    ...
    <input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search for VoIP Phones.." title="Type in a name">
     ...
     <a href="new_entry.jsp"><input type="button" value="Register New Computer"></a><input type="button" onclick="tableToExcel('customers', 'HYD_Inventory')" value="Export to Excel">
     <a href=java -jar "C:/Users/Administrator/Documents/NetBeansProjects/TEST-App/test_app/dist/test_app.jar"><input type="button" value="Java Swing"></a> <a href="application.jsp"><input type="button" value="Back"></a>
    <tr><th>Sno</th><th>PORT_NO</th><th>Location</th><th>M_NAME</th><th>M_DEPT</th><th>M_ORG</th><th>N_NAME</th><th>N_DEPT</th><th>N_ORG</th><th>HOST</th><th>MODEL</th><th>SERIAL</th><th>RAM</th>
...
String query = "select * from hyd_inventory1";
